...
module AssemblyRuby
  class BatchTransactionsApi
    ...
    # @param created_before [String] Date and time in ISO 8601 format the item(s) were created before (e.g. 2020-02-27T23:54:59Z)
    # @param created_after [String] Date and time in ISO 8601 format the item(s) were created after (e.g. 2020-02-27T23:54:59Z)
    ...
    def list_batch_transactions(created_before, created_after, opts = {})
      data, _status_code, _headers = list_batch_transactions_with_http_info(created_before, created_after, opts)
      data
    end
    ...
    def list_batch_transactions_with_http_info(created_before, created_after, opts = {})
      ...
      if @api_client.config.client_side_validation && created_before.nil?
        fail ArgumentError, "Missing the required parameter 'created_before' when calling BatchTransactionsApi.list_batch_transactions"
      end
      # verify the required parameter 'created_after' is set
      if @api_client.config.client_side_validation && created_after.nil?
        fail ArgumentError, "Missing the required parameter 'created_after' when calling BatchTransactionsApi.list_batch_transactions"
      end
