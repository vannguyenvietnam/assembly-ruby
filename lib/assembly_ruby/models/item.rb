...
module AssemblyRuby
  class Item
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ["pending", "payment_required", "wire_pending", "payment_pending", "payment_held", "payment_authorized", "void_pending", "voided", "fraud_hold", "payment_deposited", "work_completed", "problem_flagged", "problem_resolve_requested", "problem_escalated", "completed", "cancelled", "refunded", "refund_pending", "refund_flagged", "off_platform_refunded", "partial_settled", "partial_completed", "partial_paid", "off_platform_chargedback"])
      return false unless state_validator.valid?(@state)
      status_validator = EnumAttributeValidator.new('Integer', [22000, 22100, 22110, 22150, 22175, 22180, 22185, 22195, 22190, 22200, 22300, 22400, 22410, 22420, 22500, 22575, 22600, 22610, 22650, 22670, 22720, 22700, 22800, 22680])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Integer', [22000, 22100, 22110, 22150, 22175, 22180, 22185, 22195, 22190, 22200, 22300, 22400, 22410, 22420, 22500, 22575, 22600, 22610, 22650, 22670, 22720, 22700, 22800, 22680])
